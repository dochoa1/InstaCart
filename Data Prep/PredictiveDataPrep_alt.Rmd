...
# save(uid.fe, file="../Source/uid.fe.Rda")
```
...
# glimpse(product.fe)  # n = 47,155; k = 6
# save(product.fe, file="../Source/product.fe.Rda")
```
...
#   filter(user_id %in% uid.fe$user_id)
# save(user_product_streak, file="../Source/user_product_streak.Rda")
load("../Source/user_product_streak.Rda")
# glimpse(user_product_streak)  # n = 3,495,029; k = 3
```
...
# save(user_products, file="../Source/user_products.Rda")
```
