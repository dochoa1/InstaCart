---
title: "InstaCart Exploratory Analysis: Reorders - Unshortened\n"
...
train_reord <- train_n %>% 
  select(product_name, aisle, department, reordered, order_dow, order_hour_of_day)
