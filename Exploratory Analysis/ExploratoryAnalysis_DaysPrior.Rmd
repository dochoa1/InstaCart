...
```
From the visualization above we can see that most often users tend to order from InstaCart once every week (7 days). Interestingly, in second place is 30 days. Especially since the distribution of counts leading up to 30 is, in general, decreasing.
