...
We are going to conduct unsupervised learning on the adjacency matrix created above to see which aisles are more likely to be ordered together.
...
# Plot
clus7 = cutree(aisle_pairing_hc, 20)
plot(as.phylo(aisle_pairing_hc),type="fan",tip.color = clus7,
     label.offset = 1, cex = 0.7)
```

# Unsupervised Learning -- Normalized
...
# Plot
clus7 = cutree(aisle_pairing_nhc, 20)
plot(as.phylo(aisle_pairing_nhc),type="fan",tip.color = clus7,
     label.offset = 1, cex = 0.7)
```
...
```{r}
aisle_pairing_diagscale <- aisle_adjacency*(1/diag(aisle_adjacency))
...
# Plot
clus7 = cutree(aisle_pairing_diaghc, 20)
plot(as.phylo(aisle_pairing_diaghc),type="fan",tip.color = clus7,
